...
<template>
    <div class="bg-gray-50 text-black/50 dark:bg-neutral-700 dark:text-white/50">
        <div class="container mx-auto">
            ...
            <!-- Footer container -->
            <footer
                class="bg-zinc-50 text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left mt-5">
                <div
                    ...
                    <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                        <div class="">
                            ...
                            <p>
                                ...
                                We bring you the latest headlines from various sources and categories,
                                making it easy for you to stay informed about what's happening around the world.
                            </p>
                        </div>
                        <!-- Products section -->
                        <div>
